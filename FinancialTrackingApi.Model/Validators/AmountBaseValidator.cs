...
{
    public abstract class DecimalBaseValidator : IValidator
    {
        protected virtual Task<List<ValidationError>> ValidateDecimalAsync(decimal input, string propertyName)
        {
